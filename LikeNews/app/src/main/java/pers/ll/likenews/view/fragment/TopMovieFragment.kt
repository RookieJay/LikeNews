...
class TopMovieFragment : BaseFragment(), SwipeRefreshLayout.OnRefreshListener, HotMovieAdapter.OnItemClickListener {
    ...
    override fun loadData() {
        executor.execute {
            ...
            val map : LinkedHashMap<String, Any> = linkedMapOf("apikey" to Const.Param.apikey, Const.Param.start to 0, Const.Param.count to 50)
            apiService.topMovie250(map).enqueue(object : Callback<MovieResult> {
    ...
    class MovieHandler(hotMovieFragment: TopMovieFragment) : Handler() {
