...
public class Subscribers implements Parcelable {

    /**
     * birthday : -2209017600000
     * detailDescription :
     * backgroundUrl : http://p1.music.126.net/rioT9y5BnxVLFCjSIecIeA==/109951163245769206.jpg
     * gender : 2
     * city : 1010000
     * signature : I have nothing
     * description :
     * accountStatus : 0
     * avatarImgId : 109951164091177495
     * defaultAvatar : false
     * backgroundImgIdStr : 109951163245769206
     * avatarImgIdStr : 109951164091177495
     * province : 1000000
     * nickname : julyletter
     * djStatus : 0
     * avatarUrl : http://p1.music.126.net/6FV-X6yy7l9--zRfoV3lGw==/109951164091177495.jpg
     * authStatus : 0
     * vipType : 11
     * followed : false
     * userId : 14058921
     * mutual : false
     * avatarImgId_str : 109951164091177495
     * authority : 0
     * userType : 0
     * backgroundImgId : 109951163245769206
     */
    ...
    protected Subscribers(Parcel in) {
    ...
    public static final Parcelable.Creator<Subscribers> CREATOR = new Parcelable.Creator<Subscribers>() {
        @Override
        public Subscribers createFromParcel(Parcel source) {return new Subscribers(source);}

        @Override
        public Subscribers[] newArray(int size) {return new Subscribers[size];}
    };
}
