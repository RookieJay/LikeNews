...
public class RefreshParent extends LinearLayout implements NestedScrollingParent {
    ...
    public RefreshParent(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.layout_refresh_header, this, false);
                ...
                case PULLREFRESH:
                    if (mLastStatus != null) {
                        if (mRefreshCompleteListener != null) {
                            mRefreshCompleteListener.startRefresh();
                        }
                        mTvTip.setText("下拉刷新");
                        mDownAnim.start();
                    }
                    ...
                    break;
                case REFRESHING:
                    mRefreshCompleteListener.onRefresh();
                    mTvTip.setText("正在刷新");
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            //刷新完毕
                            if (mRefreshCompleteListener != null)
                                mRefreshCompleteListener.finishRefresh();
                        }
                    }, 1500);
                    break;
